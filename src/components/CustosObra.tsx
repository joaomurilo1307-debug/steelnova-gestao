    ...
    <div className="p-6">
      <div className="mb-4 grid grid-cols-2 gap-4 sm:grid-cols-3">
        <div className="rounded-xl border border-ink-800 bg-ink-900 p-4">
          ...
          <p className="mt-1 text-lg font-semibold text-white">{formatBRL(totalPrevisto)}</p>
        </div>
        <div className="rounded-xl border border-ink-800 bg-ink-900 p-4">
          <p className="text-xs uppercase text-neutral-500">Realizado</p>
          <p className="mt-1 text-lg font-semibold text-white">{formatBRL(totalRealizado)}</p>
        </div>
        <div className="rounded-xl border border-ink-800 bg-ink-900 p-4">
          <p className="text-xs uppercase text-neutral-500">Saldo</p>
          <p className={`mt-1 text-lg font-semibold ${totalPrevisto - totalRealizado >= 0 ? "text-emerald-400" : "text-red-400"}`}>
